      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="设备名称" prop="shebeimingcheng">
          <el-input v-model="ruleForm.shebeimingcheng" 
              placeholder="设备名称" clearable ></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" v-if="ruleForm.baobeishijian" label="报备时间" prop="baobeishijian">
              <el-input v-model="ruleForm.baobeishijian" 
                placeholder="报备时间" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报备内容" prop="baobeineirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baobeineirong" label="报备内容" prop="baobeineirong">
                    <span v-html="ruleForm.baobeineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shebeibaobei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeibaobeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
